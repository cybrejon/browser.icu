<script lang="ts">
  ...
  const variantStyles = {
    ...
    secondary:
      "bg-foreground-darker/20 text-white hover:bg-foreground/40 shadow-foreground/10",
  ...
  const buttonClasses = /* tw */ $derived(
    cn(
      ...
      sizeStyles[size],
      !noOutline &&
        "outline outline-transparent focus:outline-foreground-darker",
