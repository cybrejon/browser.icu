...
<div id="ref">
	...
	>
		...
		>
			...
			>
				<div>
					<Icon icon="fluent:cursor-28-filled" />
				</div>
				<div class="pt-2">
					<p class=" bg-foreground text-background rounded-full px-2 py-1 text-xs">Agent</p>
				</div>
			</div>
			<!-- cursor end -->
			...
			>
				<div class="border-border bg-accent/10 col-span-3 h-20 overflow-hidden border">
				...
				<div class="border-border bg-primary/10 col-span-2 overflow-hidden border">
					<img class="h-full object-cover" src={dexscreener} alt="google" />
				</div>
				<div class="border-border bg-secondary/10 col-span-2 overflow-hidden border">
		...
		<div class="border-border flex items-center justify-between border-t px-3 py-2">
			<div class="flex items-center gap-3">
				<Icon icon="ri:mic-line" class="cursor-pointer" />
				<p class="text-foreground-darker">Do everything.</p>
			</div>
			<Icon icon="tdesign:enter" class="cursor-pointer" />
		</div>
	</div>
</div>

{#snippet task(title: string, description: string, position: Position, animation: string)}
	<div
